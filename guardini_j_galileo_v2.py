...
st.divider()
with col_2:
    st.title('Forecasting Materiali | :orange[NeuralProphet]')
...
with st.expander('Anteprima dati caricati'):
    col_caricato, col_era_diventa, col_promo = st.columns([4, 1,1])
    with col_caricato:
...
# Mantenere righe di df_venduto['Classe di valutazione 1'] che sono uguali a 'PF interno+confez.'
df_venduto = df_venduto[df_venduto['Classe di valutazione 1'] == 'PF interno+confez.']
